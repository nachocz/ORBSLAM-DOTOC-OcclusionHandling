...
protected:
    //Dense Map creation function.

    void DenseMapCreation(const cv::Mat &dmcTcwTemporal, const cv::Mat dmcImColor, const cv::Mat dmcImDepth);
    ...
    float closeThreshold, farThreshold;

    //DOT resolution reduction parameter
